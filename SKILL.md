...
4. Render the digest.
   ...
   - **Automatic weekly draft mode:** when the account lacks verified `freepublish/submit` permission, upload a draft only and stop. Do not publish the site until the user confirms the article was manually published in the Official Account backend.
